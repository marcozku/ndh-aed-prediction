...
const SW_VERSION = '3.0.85';
const CACHE_NAME = 'ndh-aed-v3.0.85';
const STATIC_CACHE = 'ndh-static-v3.0.85';
const DYNAMIC_CACHE = 'ndh-dynamic-v3.0.85';
...
console.log('[SW] Service Worker 已載入 v3.0.85');
