...
## v3.0.83 - 2026-01-06 00:30 HKT
**🎯 UI 更新：雙軌導航 + 演進時間線數據修復 + Metrics 同步**

### UI 改進
- ✅ **新增雙軌導航按鈕**：導航欄新增「🔬 雙軌」連結至 `/dual-track.html`
- ✅ **修復演進時間線 fallback 數據**：更新為最新 MAE 6.18、MAPE 2.42%
- ✅ **雙軌頁面返回按鈕**：`dual-track.html` 新增「← 返回」連結回主頁
- ✅ **方法論彈窗顯示 R²**：修復 R² 指標不顯示問題

### Backend 改進
- ✅ **Metrics 自動同步**：啟動時自動比較文件與數據庫 metrics，取較新者同步
- ✅ **智能數據源選擇**：`getModelStatusAsync` 現比較日期選擇最新 metrics
